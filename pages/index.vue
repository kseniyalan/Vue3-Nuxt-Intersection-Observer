  ...
  <div class="container py-4 py-md-6">
    <div class="fade-in-delay-wrapper" :ref="el => sectionRefs.push(el)">
      <TextBlock>
        ...
        <template #text-main>
          The Intersection Observer API provides a way to <span class="red">asynchronously observe</span> changes in the intersection of a target element with an ancestor element or with a top-level document's viewport.
        </template>
      </TextBlock>
    </div>
    ...
    <div class="fade-in-delay-wrapper" :ref="el => sectionRefs.push(el)">
      <TextBlock>
        <template #text-top><span class="green">Next!</span></template>
        <template #text-main>
    ...
    <div class="col-12 col-md-7 py-4 py-md-6 mx-auto">
